...
Source0: v%{version}/%{pname}-%{version}.tar.gz
ExclusiveOS: linux
BuildRequires: gcc
BuildRequires: git
...
Provides: %{pname}-runtime
Obsoletes: %{pname}-runtime
...
%files
%doc %{name}-%{version}/gopath/%{singgopath}/examples %{name}-%{version}/gopath/%{singgopath}/*.md
