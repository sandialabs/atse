...
#Source0:   https://download.open-mpi.org/release/open-mpi/v4.0/openmpi-4.0.3.tar.bz2
...
BASEFLAGS="--prefix=%{install_path} --enable-static --enable-shared --disable-dlopen --disable-wrapper-rpath --disable-wrapper-runpath --enable-builtin-atomics --with-sge --enable-mpi-cxx --enable-mpi1-compatibility --without-verbs --enable-mca-no-build=btl-uct"
...
# OpenMPI 4.x integration with SLURM is somehow broken, force use of PMIx to workaround
setenv          SLURM_MPI_TYPE          pmix_v2
setenv          OHPC_MPI_LAUNCHERS      pmix_v2
