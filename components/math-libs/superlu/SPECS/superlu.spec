...
Documentation can be found on http://www.netlib.org.
...
install -m755 SRC/libsuperlu.a %{buildroot}%{install_path}/lib/libsuperlu.a
...
puts stderr " "
puts stderr "Note that this build of SuperLU leverages BLAS linear algebra libraries."
puts stderr "Thus, a BLAS module must be loaded with this module for it to be functional."
puts stderr "If in doubt, 'module load openblas' to get a BLAS library."
