...
BuildRequires:  zlib-%{compiler_family}%{PROJ_DELIM} >= 1.2.5
Requires:       zlib-%{compiler_family}%{PROJ_DELIM} >= 1.2.5
Requires:       lmod%{PROJ_DELIM} >= 7.6.1
BuildRequires:  phdf5-%{compiler_family}-%{mpi_family}%{UARCH_DELIM}%{PROJ_DELIM}
BuildRequires:  netcdf-%{compiler_family}-%{mpi_family}%{UARCH_DELIM}%{PROJ_DELIM}
Requires:       netcdf-%{compiler_family}-%{mpi_family}%{UARCH_DELIM}%{PROJ_DELIM}
...
export CPPFLAGS="-I$HDF5_INC -I$NETCDF_INC -I$PNETCDF_INC"
export LDFLAGS="-L$HDF5_LIB -L$NETCDF_LIB -L$PNETCDF_LIB"
...
setenv          NETCDF_CXX_DIR      %{install_path}
setenv          NETCDF_CXX_BIN      %{install_path}/bin
setenv          NETCDF_CXX_LIB      %{install_path}/lib
setenv          NETCDF_CXX_INC      %{install_path}/include
