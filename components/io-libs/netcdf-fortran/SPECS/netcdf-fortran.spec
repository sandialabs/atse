...
BuildRequires:  phdf5-%{compiler_family}-%{mpi_family}%{UARCH_DELIM}%{PROJ_DELIM} >= 1.8.8
...
setenv          NETCDF_FORTRAN_DIR  %{install_path}
setenv          NETCDF_FORTRAN_BIN  %{install_path}/bin
setenv          NETCDF_FORTRAN_LIB  %{install_path}/lib
setenv          NETCDF_FORTRAN_INC  %{install_path}/include
